    ...
    $('#typed-vim').typed({
      strings: [
        [
          ...
          '<div style="height:8px"></div><span class="terminal-padding"><span style="color: #788DD1;">constructor</span> () <span class="terminal-padding2" style="color: #788DD1;">public</span>',
