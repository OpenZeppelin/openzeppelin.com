    ...
    $('#typed-vim').typed({
      strings: [
        [
          ...
          '<div style="height:8px"></div><span class="terminal-padding"><span style="color: #788DD1;">constructor</span> () <span style="color: #788DD1;">public</span><span class="mobile-br">&nbsp;</span>ERC20Detailed("ExampleToken", "EGT", 18) {',
          '<span class="terminal-padding2">_mint(msg.sender, <span class="mobile-br">&nbsp;</span>10000 * (10 ** uint256(decimals())));</span>',
